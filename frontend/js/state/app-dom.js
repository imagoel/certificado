...
const formsRefreshBtn = document.getElementById("forms-refresh");
const certificateFormForm = document.getElementById("certificate-form-form");
const certificateFormEditIdInput = document.getElementById("certificate-form-edit-id");
const certificateFormSecretariaSelect = document.getElementById("certificate-form-secretaria");
const certificateFormTitleInput = document.getElementById("certificate-form-title");
const certificateFormCourseInput = document.getElementById("certificate-form-course");
...
const certificateFormEmailRequiredInput = document.getElementById("certificate-form-email-required");
const certificateFormActiveInput = document.getElementById("certificate-form-active");
...
const certificateFormExtra1OptionsInput = document.getElementById("certificate-form-extra-1-options");
const certificateFormExtra1RequiredInput = document.getElementById("certificate-form-extra-1-required");
const certificateFormExtra2Input = document.getElementById("certificate-form-extra-2");
const certificateFormExtra2LabelInput = document.getElementById("certificate-form-extra-2-label");
const certificateFormExtra2TypeSelect = document.getElementById("certificate-form-extra-2-type");
const certificateFormExtra2OptionsInput = document.getElementById("certificate-form-extra-2-options");
const certificateFormExtra2RequiredInput = document.getElementById("certificate-form-extra-2-required");
const certificateFormExtra3Input = document.getElementById("certificate-form-extra-3");
const certificateFormExtra3LabelInput = document.getElementById("certificate-form-extra-3-label");
const certificateFormExtra3TypeSelect = document.getElementById("certificate-form-extra-3-type");
const certificateFormExtra3OptionsInput = document.getElementById("certificate-form-extra-3-options");
const certificateFormExtra3RequiredInput = document.getElementById("certificate-form-extra-3-required");
const certificateFormResetBtn = document.getElementById("certificate-form-reset");
const certificateFormStatus = document.getElementById("certificate-form-status");
const certificateFormListBody = document.getElementById("certificate-form-list-body");
const formResponsesPanel = document.getElementById("form-responses-panel");
const formResponsesTitle = document.getElementById("form-responses-title");
const formResponsesSummary = document.getElementById("form-responses-summary");
const formResponsesStatus = document.getElementById("form-responses-status");
const formResponsesListBody = document.getElementById("form-responses-list-body");
